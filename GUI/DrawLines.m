...
if  size(colormatrix,2)==1
    for i=1:1:Fin
        plot3(x(1,i),y(1,i),z(1,i),'Marker','o','MarkerFaceColor',  colormatrix,'MarkerEdgeColor',RandomDotsColor,'Hittest','off','MarkerSize',Markersize);
    end
else   
...
if cost == Inf
    ...
    msgbox('Way beetwen this dots, with such radius, do not exist.');
elseif cost==0
